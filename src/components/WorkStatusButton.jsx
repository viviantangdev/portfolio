...
export const WorkStatusButton = () => {
  ...
  return (
    <div className='flex justify-center animate-fade-in opacity-0 [animation-delay:1.1s]'>
      <button className='flex items-center gap-5 px-3 py-2 font-light text-white duration-300 border shadow-md backdrop-blur-md border-green-400/10 bg-green-400/10 rounded-xl'>
        {/* Pulsing Dot */}
